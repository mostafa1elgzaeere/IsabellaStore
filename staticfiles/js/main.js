...
let news=document.getElementsByClassName("newsletter__submit")[0];
news.onclick=()=>{
	swal({  
		title: " Oops!",  
		text: " Something went wrong, you should try again!",  
		type: "warning",  
		button: "oh no!",  
	  });  
	}

let formm=document.getElementsByClassName("formnews")[0];
